...
export default function AppLayout() {
  ...
  const SidebarContent = (
    <>
      <div className="px-6 py-4 text-xl font-semibold border-b text-white" style={{ borderColor: 'rgba(255,255,255,0.2)' }}>
      ...
      <div className="mt-auto px-3 py-4 border-t" style={{ borderColor: 'rgba(255,255,255,0.2)' }}>
...
function NavItem({ to, icon, children }) {
  return (
    <NavLink
      to={to}
      className={({ isActive }) =>
        `flex items-center gap-3 px-3 py-2 text-sm font-medium transition rounded-lg ${isActive
