        ...
        <div className="bg-white border border-slate-200 p-6">
            ...
            >
                ...
                <label htmlFor={`upload-${title}`}>
                    <span className="inline-block px-4 py-2 bg-white border border-slate-300 text-slate-700 rounded font-medium text-sm cursor-pointer hover:bg-slate-50 transition-colors">
                        Select File
                    </span>
                </label>
